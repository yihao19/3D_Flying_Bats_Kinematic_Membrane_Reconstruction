...
def load_kinematics(armature, start_frame:int, end_frame:int, reconstruction_project:str) -> None:
    """
    ...
    for file_index in range(start_frame,end_frame+1): 
            #print(file_index)
        #if file_index == 1:
        json_file_path = f"D:/PhDProject_real_data/{reconstruction_project}/rearrange_pose/{file_index}/membrane_output.json"
...
def membrane_reconstruction_render(config) -> None: 
    ...
    load_kinematics(armature, start_frame, end_frame, reconstruction_project)
    ...
    bpy.ops.wm.quit_blender()  # quit blender
    return None
...
# Find the index of '--' to separate Blender's arguments from custom ones
    ...
    blender_config = {"start_frame":int(start_frame)-1, 
    ...
    blender ./membrane_blender/bat_test_13_2/bat_test_13_2.blend --python-use-system-env --python blender_script_template.blend.py -- D:/PhDProject_real_data bat_test_13_2 3 10 0.08670005921693345
    """
