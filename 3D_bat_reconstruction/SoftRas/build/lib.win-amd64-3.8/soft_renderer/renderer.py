...
class Renderer(nn.Module):
    def __init__(self, image_height=256, image_width=256, background_color=[0,0,0], near=1, far=100, 
        ...
        # rasterization
        self.rasterizer = sr.Rasterizer(image_height, image_width, background_color, near, far, 
...
class SoftRenderer(nn.Module):
    def __init__(self, image_height=256, image_width=256,  background_color=[0,0,0], near=1, far=100, 
                 ...
                 camera_mode='projection',
                 P=None, dist_coeffs=None, orig_height=512, orig_width=512,
                 perspective=True, viewing_angle=30, viewing_scale=1.0, 
                 eye=None, camera_direction=[0,0,1],
                 light_mode='surface',
                 light_intensity_ambient=0.5, light_color_ambient=[1,1,1],
        ...
        # camera
        self.transform = sr.Transform(camera_mode, 
                                      P, dist_coeffs, orig_height,orig_width,
                                      perspective, viewing_angle, viewing_scale, 
                                      eye, camera_direction)

        # rasterization
        self.rasterizer = sr.SoftRasterizer(image_height, image_width, background_color, near, far, 
                                            anti_aliasing, fill_back, eps,
    ...
    def render_mesh(self, mesh, mode=None):
        ...
        # check if the mesh vertices is correct
