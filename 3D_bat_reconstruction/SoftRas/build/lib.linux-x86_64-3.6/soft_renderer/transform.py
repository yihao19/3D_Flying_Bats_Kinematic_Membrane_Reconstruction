...
class Projection(nn.Module):
    def __init__(self, P, dist_coeffs=None, orig_height=512, orig_width=512):
    ...
    def forward(self, vertices):
        vertices = srf.projection(vertices, self.P, self.dist_coeffs, self.orig_height, self.orig_width)
        return vertices
...
class Transform(nn.Module):
    def __init__(self, camera_mode='projection', P=None, dist_coeffs=None, orig_height=512, orig_width=512,
        ...
        if self.camera_mode == 'projection':
            self.transformer = Projection(P, dist_coeffs, orig_height, orig_width)
