#!/bin/bash
#SBATCH -J Brunei_2023_bat_test_14_1_driver   # Name of the job
...
python /home/yihao19/PhD_research/3D_bat_reconstruction/SoftRas/models/membrane_kinematic_optimization_model/drivers/2023/Brunei_2023_bat_test_14_1_driver.py