#!/bin/bash
#SBATCH -J Brunei_2023_bat_15_2_driver_membrane   # Name of the job
...
python /home/yihao19/3D_Flying_Bats_Kinematic_Membrane_Reconstruction/3D_bat_reconstruction/membrane_kinematic_optimization_model/drivers/2023/Brunei_2023_bat_15_2_driver.py