#!/bin/bash
#SBATCH -J Brunei_2024_HIPCER019_FlightTest1_2_4_driver_reverse   # Name of the job
...
python /home/yihao19/PhD_research/3D_bat_reconstruction/SoftRas/models/membrane_kinematic_optimization_model/drivers/2024/HIPCER019_FlightTest1_2_4_driver.py