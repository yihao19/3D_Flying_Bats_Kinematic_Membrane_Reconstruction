#!/bin/bash
#SBATCH -J Brunei_2024_HIPCER021_FlightTest2_5_7_driver   # Name of the job
...
python /home/yihao19/3D_Flying_Bats_Kinematic_Membrane_Reconstruction/3D_bat_reconstruction/membrane_kinematic_optimization_model/drivers/2024/HIPCER021_FlightTest2_5_7_driver.py