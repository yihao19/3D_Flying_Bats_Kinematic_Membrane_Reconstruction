#!/bin/bash
#SBATCH -J Brunei_2024_HIPCER025_FlightTest2_2_4_driver_kinematic_refine  # Name of the job
...
python /home/yihao19/3D_Flying_Bats_Kinematic_Membrane_Reconstruction/3D_bat_reconstruction/membrane_kinematic_optimization_model/drivers/2024/HIPCER025_FlightTest2_2_4_driver.py