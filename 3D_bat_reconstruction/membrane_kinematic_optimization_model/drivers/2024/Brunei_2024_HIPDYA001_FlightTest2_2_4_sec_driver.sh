#!/bin/bash
#SBATCH -J Brunei_2024_HIPDYA001_FlightTest2_2_4_sec_driver_membrane_opt   # Name of the job
...
python /home/yihao19/3D_Flying_Bats_Kinematic_Membrane_Reconstruction/3D_bat_reconstruction/membrane_kinematic_optimization_model/drivers/2024/HIPDYA001_FlightTest2_2_4_sec_driver.py